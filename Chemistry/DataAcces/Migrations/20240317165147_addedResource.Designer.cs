...
namespace DataAcces.Migrations
{
    ...
    [Migration("20240317165147_addedResource")]
    partial class addedResource
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Curseİnfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("VideoLesson")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("Curseİnfos");
                });
            ...
            modelBuilder.Entity("Core.Entities.QuizAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.QuizCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.MailSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.PersonInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.VideoLesson", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.VideoLessonCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VideoLessonCategories");
                });
            ...
            modelBuilder.Entity("Core.Entities.Quiz", b =>
                {
                    b.HasOne("Core.Entities.QuizCategory", "QuizCategory")
                        .WithMany("Quizzes")
            ...
            modelBuilder.Entity("Core.Entities.VideoLesson", b =>
                {
                    b.HasOne("Core.Entities.VideoLessonCategory", "Category")
